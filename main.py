...
class Window(tk.Frame):
    ...
    def init_window(self):
        ...
        self.inputfilepathText = Entry(
            frame1, textvariable=self.inputfilepath, font=self.font
        )
        ...
        self.inputvideofileText = Entry(
            frame2, textvariable=self.inputvideofile, font=self.font
        )
        ...
        self.outputfilepathText = Entry(
            frame3, textvariable=self.outputfilepath, font=self.font
        )
        ...
        self.outputvideofileText = Entry(
            frame9, textvariable=self.outputvideofile, font=self.font
        )
        ...
        self.signText = Entry(
            frame5, textvariable=self.display_sign, font=self.font
        )
        ...
        self.sequenceText = Entry(
            frame6, textvariable=self.display_sequence, font=self.font
        )
    ...
    def show_videofile_browser(self):
        ...
        self.filename = filedialog.askopenfilename(
            initialdir=init_dir, filetypes=ftypes
        )
        ...
        for file in listfile:
            ...
            for mp4list in fullfilename:
                if ".DS_Store" in mp4list:
                    continue
                inputfilen = (
                    "   --input_video_path=" + input_data_path + word + mp4list
                )
                outputfilen = (
                    "   --output_video_path="
                    + output_data_path
    ...
    def get_idx(self, numbers, split_idx):
        while (
            numbers[split_idx] != 0
            or numbers[split_idx + 1] != 0
            or numbers[split_idx + 2] != 0
            or numbers[split_idx + 3] != 0
            or numbers[split_idx + 4] != 0
            or numbers[split_idx + 5] != 0
            or numbers[split_idx + 6] != 0
            or numbers[split_idx + 7] != 0
            or numbers[split_idx + 8] != 0
            or numbers[split_idx + 9] != 0
            or numbers[split_idx + 10] != 0
            or numbers[split_idx + 11] != 0
            or numbers[split_idx + 12] != 0
            or numbers[split_idx + 13] != 0
            or numbers[split_idx + 14] != 0
            or numbers[split_idx + 15] != 0
            or numbers[split_idx + 16] != 0
            or numbers[split_idx + 17] != 0
            or numbers[split_idx + 18] != 0
            or numbers[split_idx + 19] != 0
            or numbers[split_idx + 20] != 0
            or numbers[split_idx + 21] != 0
            or numbers[split_idx + 22] != 0
            or numbers[split_idx + 23] != 0
            or numbers[split_idx + 24] != 0
            or numbers[split_idx + 25] != 0
            or numbers[split_idx + 26] != 0
            or numbers[split_idx + 27] != 0
            or numbers[split_idx + 28] != 0
            or numbers[split_idx + 29] != 0
            or numbers[split_idx + 30] != 0
            or numbers[split_idx + 31] != 0
            or numbers[split_idx + 32] != 0
            or numbers[split_idx + 33] != 0
            or numbers[split_idx + 34] != 0
            or numbers[split_idx + 35] != 0
            or numbers[split_idx + 36] != 0
            or numbers[split_idx + 37] != 0
            or numbers[split_idx + 38] != 0
            or numbers[split_idx + 39] != 0
            or numbers[split_idx + 40] != 0
            or numbers[split_idx + 41] != 0
            or numbers[split_idx + 42] != 0
            or numbers[split_idx + 43] != 0
            or numbers[split_idx + 44] != 0
            or numbers[split_idx + 45] != 0
            or numbers[split_idx + 46] != 0
            or numbers[split_idx + 47] != 0
            or numbers[split_idx + 48] != 0
            or numbers[split_idx + 49] != 0
            or numbers[split_idx + 50] != 0
            or numbers[split_idx + 51] != 0
            or numbers[split_idx + 52] != 0
            or numbers[split_idx + 53] != 0
            or numbers[split_idx + 54] != 0
            or numbers[split_idx + 55] != 0
            or numbers[split_idx + 56] != 0
            or numbers[split_idx + 57] != 0
            or numbers[split_idx + 58] != 0
            or numbers[split_idx + 59] != 0
            or numbers[split_idx + 60] != 0
            or numbers[split_idx + 61] != 0
            or numbers[split_idx + 62] != 0
            or numbers[split_idx + 63] != 0
            or numbers[split_idx + 64] != 0
            or numbers[split_idx + 65] != 0
            or numbers[split_idx + 66] != 0
            or numbers[split_idx + 67] != 0
            or numbers[split_idx + 68] != 0
            or numbers[split_idx + 69] != 0
            or numbers[split_idx + 70] != 0
            or numbers[split_idx + 71] != 0
            or numbers[split_idx + 72] != 0
            or numbers[split_idx + 73] != 0
            or numbers[split_idx + 74] != 0
            or numbers[split_idx + 75] != 0
            or numbers[split_idx + 76] != 0
            or numbers[split_idx + 77] != 0
            or numbers[split_idx + 78] != 0
            or numbers[split_idx + 79] != 0
            or numbers[split_idx + 80] != 0
            or numbers[split_idx + 81] != 0
            or numbers[split_idx + 82] != 0
            or numbers[split_idx + 83] != 0
        ):
            split_idx += 1
        return split_idx
